...
const CompareTable = dynamic(() => import('./dynamicComponents/CompareTable').then(mod => ({ default: mod.CompareTable })), {
  loading: () => <div className="animate-pulse h-96 bg-gray-200 rounded" />,
})
const ContentItem = dynamic(() => import('./dynamicComponents/ContentItem').then(mod => ({ default: mod.ContentItem })), {
  loading: () => <div className="animate-pulse h-64 bg-gray-200 rounded" />,
})
const DescriptionBlock = dynamic(() => import('./dynamicComponents/DescriptionBlock').then(mod => ({ default: mod.DescriptionBlock })), {
  loading: () => <div className="animate-pulse h-48 bg-gray-200 rounded" />,
})
const ShortArticles = dynamic(() => import('./dynamicComponents/ShortArticles').then(mod => ({ default: mod.ShortArticles })), {
  loading: () => <div className="animate-pulse h-96 bg-gray-200 rounded" />,
})
const LogoSlider = dynamic(() => import('./LogoSlider').then(mod => ({ default: mod.LogoSlider })), {
